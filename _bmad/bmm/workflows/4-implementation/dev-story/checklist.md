...
## 🎨 FIGMA VERIFICATION (MANDATORY FOR UI WORK)

> **HARD RULE:** NEVER implement UI without Figma verification

- [ ] **Figma Access Confirmed:** User has connected Figma via MCP before ANY UI implementation began
- [ ] **Design Values Verified:** ALL design tokens, colors, spacing, typography verified against actual Figma file (NOT just documentation)
- [ ] **Component Styling Verified:** ALL component styles match Figma designs exactly
- [ ] **No Assumptions Made:** Zero UI values were assumed or taken solely from story documentation
